      ...
      <section className="section">
        <div className="container profile-layout">
          ...
          <div>
            ...
            <p>
              社会人経験のなかでも、8年超にわたる経営コンサルティング経験をもとに、「傍を楽にする」ことを活動の軸として、
        ...
        <div className="container narrow">
          ...
          <div className="background-block">
            ...
            <ul className="check-list">
              <li>DE&I施策設計、中期経営計画および人事制度改変における全社向けコミュニケーションプラン設計、幹部候補の中堅社員向けリーダーシップ開発計画設計、女性リーダー育成に向けた等級制度・研修計画設計などを牽引。</li>
              <li>グローバル人材活用プロジェクトにて、コンサルティンググループ関連各社の各国籍の経営層へのインタビュー、組織課題分析、To-Beモデル設計、改善施策提案、実行ロードマップ策定を担当。</li>
              <li>
                経営幹部候補/管理職/リーダー層/新入社員向けの研修・ワークショップ各種設計、および対面/オンライン講師として累計800名以上を担当。
                <br />
                担当分野：パーパス浸透、新卒/キャリア採用向けオンボーディング研修、ビジネス知識基礎、営業力強化、企業コンプライアンス研修各種（DE&I、メンタルヘルス・マネジメント、ハラスメント防止 等）、およびリーダーシップ開発 など
              </li>
            </ul>
          </div>
          <div className="background-block">
            <h3>事業推進・業務改善領域</h3>
            <ul className="check-list">
              <li>年商40億円規模の営業チームリードに就任し、PMおよび商談窓口として、業務提携・資本提携先との取引基盤構築プロジェクトを牽引。</li>
              <li>EC事業統括部署のリードとして、週15時間相当のチーム内業務改善を達成。</li>
              <li>200社以上を対象としたEDI導入プロジェクトにおいて、80%以上の承諾を獲得。</li>
              <li>無形商材の営業において、所属チームで唯一、大手建材企業との純利益200万円規模の案件を成約。</li>
              <li>大手ホームセンター商品事業部との協働により、OEM商品開発企画およびLP制作企画を推進。</li>
            </ul>
          </div>
          <div className="background-block">
            <h3>個人支援・自事業領域</h3>
            <ul className="check-list">
              ...
              <li>1on1日本語レッスン 累計 70名、820レッスン完了。（2026年9月25日時点）</li>
            </ul>
          </div>
        </div>
      </section>
